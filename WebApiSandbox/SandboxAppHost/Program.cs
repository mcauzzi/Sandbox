...
builder.AddProject<Projects.AuthWebApi>("AuthWebApi").WaitForCompletion(authDbMigrationService).WithReference(authDb);
builder.AddProject<Projects.WebApiSandbox>("WeatherWebApi")
